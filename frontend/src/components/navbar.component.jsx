    ...
    return (
        <>
            <nav className="navbar">
             ...
             border-b border-grey py-4 px-[5vw] md:border-0 md:block 
             md:relative md:inset-0 md:p-0 md:w-auto md:show ` + (searchBoxVisiblity ? "show" : "hide")}>
                    <input type="text"
                        placeholder="Search"
                ...
                flex items-center justify-center" onClick={() => setSearchBoxVisibility(currectVal => !currectVal)}>
